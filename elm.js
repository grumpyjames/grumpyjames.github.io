...
Elm.Arrays = Elm.Arrays || {};
Elm.Arrays.make = function (_elm) {
   "use strict";
   _elm.Arrays = _elm.Arrays || {};
   if (_elm.Arrays.values)
   return _elm.Arrays.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Native$Arrays = Elm.Native.Arrays.make(_elm);
   var cartesian = F3(function (f,
   xs,
   ys) {
      return A3($Native$Arrays.cartesian,
      f,
      $Array.fromList(xs),
      $Array.fromList(ys));
   });
   _elm.Arrays.values = {_op: _op
                        ,cartesian: cartesian};
   return _elm.Arrays.values;
};
                              ...
                              return _U.replace([["mouseState"
                                                 ,{ctor: "_Tuple2"
                                                  ...
                                                  ,_1: {ctor: "_Tuple2"
                                                       ...
                                                       ,_1: _v2._1._1}}]],
                                model);
                              case true: switch (_v8._1.ctor)
                                {case "_Tuple2":
                                   return function () {
                                        var newModel = A2(applyDrag,
                                        model,
                                        {ctor: "_Tuple2"
                                        ,_0: _v8._1._0 - _v2._1._0
                                        ,_1: _v2._1._1 - _v8._1._1});
                                        return _U.replace([["mouseState"
                                                           ,{ctor: "_Tuple2"
                                                            ,_0: _v2._0
                                                            ,_1: {ctor: "_Tuple2"
...
Elm.Tile.make = function (_elm) {
   ...
   $Types = Elm.Types.make(_elm);
   var rows = function (f) {
      return $Basics.uncurry($Arrays.cartesian(f));
   };
   ...
   arr) {
      return function () {
         ...
         r,
         els) {
            return $Graphics$Element.flow(dir)($List.map(r)($Array.toList(els)));
         });
   ...
   var originOffset = F3(function (tileSize,
   tileCounts,
   centrePixel) {
      return function () {
         ...
         ,_1: halfTile},
         centrePixel.pixels);
         return $Types.Position(flipY(pixelOffsets));
      }();
   });
   ...
   distance) {
      return $Graphics$Collage.move(A2($Tuple.map,
      $Basics.toFloat,
